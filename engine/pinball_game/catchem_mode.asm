...
LoadBillboardGraphics: ; 0x10432
	ld a, BANK(TileData_Billboard)
	ld bc, TileData_Billboard
	ld de, LoadTileLists
	call QueueGraphicsToLoadWithFunc
	ret

TileData_Billboard: ; 0x1043e
	db $18	; total number of tiles

	db $06	; number of tiles
	dw vBGMap + $87	; destination
	db $90, $91, $92, $93, $94, $95	; tiledata
